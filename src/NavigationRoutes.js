...
const TabsNavigator = createBottomTabNavigator(
  {
    ...
    VisitasTab: {
      ...
      navigationOptions: {
        ...
        tabBarAccessibilityLabel:
          "Icono del acceso a la lista de visitas desde el menu",
        tabBarIcon: ({ focused }) =>
          focused ? (
            <Image
              style={{ width: 25, height: 25 }}
    ...
    OportunidadesTab: {
      ...
      navigationOptions: {
        ...
        tabBarAccessibilityLabel:
          "Icono del acceso a la vista de lista de oportunidades desde el menu",
        tabBarIcon: ({ focused }) =>
          focused ? (
            <Image
              style={{ width: 25, height: 25 }}
...
const AppStack = createStackNavigator(
  {
    ...
    FormularioVisitaPriorizadaStack: {
      screen: FormularioVisitaPriorizadaStack,
    },
