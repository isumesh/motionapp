...
const mapDispatchToProps = (dispatch) => {
  return {
    actions: bindActionCreators(
      { signIn, limpiarSignIn, modalIsVisible },
      dispatch
    ),
  };
};
...
class LoginForm extends Component<Props> {
  ...
  onPressLogin = () => {
    LOGIN_VALIDATION_SCHEMA.validate(this.state)
      .then(() => {
  ...
  render() {
    ...
    const userIcon = (
      <Image
        ...
        source={require("../../../assets/images/icons/username_login.png")}
      />
    );
    const passIcon = (
      <Image
        style={styles.inputPassIcon}
        source={require("../../../assets/images/icons/pass_login.png")}
      />
    );
    return (
      <View>
        ...
        <View>
          ...
          >
            <Text style={styles.buttonLoginLabel}>Login</Text>
            {signingWithCredentials && (
