...
class FormularioVisitaPriorizadaScreen extends Component<Props> {
  static navigationOptions = ({ navigation, screenProps }) => ({
    headerTitle: `${
      navigation.getParam("visitaId") ? "Edición" : "Nueva"
    } visita Priorizada`,
    headerLeft: (
      <GoBackButton
        onPress={() => {
  ...
  validarOportunidadesRequeridas = () => {
    ...
    return (
      !!subdetalleVisita &&
      subdetalleVisita !== "Cierre de Negocio" &&
      _.isEmpty(form["oportunidades"])
    );
  };
      ...
      return (
        <View key={key}>
          <View style={inputStyle}>
            ...
            {name === "Gestión de la visita" ? (
              <TouchableOpacity
                onPress={() =>
                  hideEditPrio ? null : this.setState({ [tituloModal]: true })
                }
              >
  ...
  renderForm = () => {
    ...
    const oportunidadRequeridaMssg =
      requeridosFaltantes && oportunidadRequerida;
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(FormularioVisitaPriorizadaScreen);
