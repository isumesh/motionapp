...
import ResumenOportVisitaRealizadaScreen from "./ResumenOportVisitaRealizadaScreen";
...
class ResumenVisitaScreen extends Component<Props> {
      ...
      <View style={styles.container}>
        <View style={styles.summaryContainer}>
          <View style={styles.detailsContainer}>
            {w === "" ? null : (
              <View style={styles.simpleContainer}>
                <Text style={styles.title}>
                  {w.pregunta !== "undefined" && w.pregunta}
                </Text>
                <Text style={styles.value}>
                  {w.respuesta !== "undefined" && w.respuesta}
                </Text>
              </View>
            )}
            ...
            <View style={styles.simpleContainer}>
              ...
              <View style={{ flexDirection: "row" }}>
                <Text style={[styles.value]}>
                  {fechaCr === undefined
                    ? ""
                    : moment(fechaCr, "YYYY-MM-DD").format("YYYY-MM-DD")}
                </Text>
              </View>
            </View>
            ...
            <View style={styles.simpleContainer}>
              <View style={{ flexDirection: "row" }}>
                <Text style={[styles.title, styles.twoCol]}>
                  Fecha de visita:
                </Text>
                <Text style={[styles.title, styles.twoCol]}>
                  Tipo de visita:
            ...
            {c === "" ? null : (
              <View style={styles.simpleContainer}>
                <Text style={styles.title}>
                  {c.pregunta !== "undefined" && c.pregunta}
                </Text>
                <View style={{ flexDirection: "row" }}>
                  <Text style={styles.value}>
                    {c.respuesta !== "undefined" && c.respuesta}
                  </Text>
                </View>
              </View>
            )}
            ...
            <View style={styles.simpleContainer}>
              <View style={{ flexDirection: "row" }}>
                <Text style={[styles.title, styles.twoCol]}>
                  {x.pregunta !== "undefined" && x.pregunta}
                </Text>
                <Text style={[styles.title, styles.twoCol]}>
                  {r.pregunta !== "undefined" && r.pregunta}
                </Text>
              </View>
              <View style={{ flexDirection: "row" }}>
                <Text style={[styles.value, styles.twoCol]}>
                  {x.respuesta !== "undefined" && x.respuesta}
                </Text>
                <Text style={[styles.value, styles.twoCol]}>
                  {r.respuesta !== "undefined" && r.respuesta}
                </Text>
              </View>
            </View>
            <View style={styles.simpleContainer}>
            ...
            {_.isEmpty(riesgos) ? null : (
              <View>
                ...
                <View style={styles.simpleContainer}>
                  <Text
                    style={[styles.title, { marginBottom: 10, color: BLACK }]}
                  >
                    Preguntas de riesgos:
                  </Text>
                  <View>
                    {_.map(riesgos, (riesgo, i) => {
                      ...
                      const resumenRiesgoModalName = [
                        `ResumenRiesgo[${i}]Visible`,
                      ];
                      ...
                      return (
                        <Row key={i}>
                          <TouchableOpacity
                            onPress={() =>
                              this.obtenerResumenRiesgo(resumenRiesgoModalName)
                            }
                          >
                            <RiesgoCard
                              key={i}
                              ...
                              >
                                ...
                                <ScrollView>
                                  {oportunidadId && _.isEmpty(oportunidad) ? (
                                    ...
                                    <ResumenOportVisitaRealizadaScreen
  ...
  render() {
    return (
      <ScrollView style={styles.container}>{this.renderSummary()}</ScrollView>
    );
  }
}
