...
import { View, ScrollView, Text, TouchableOpacity, StyleSheet, BackHandler,Image,ImageBackground } from 'react-native'
            ...
            return (
                <ScrollView style={styles.container} >
                    <View style={styles.cardContainer}>
                        <Text
                              style={{ color: 'black', fontSize: 35, fontWeight: 'bold', textTransform: 'capitalize', marginBottom: 10 }} >
