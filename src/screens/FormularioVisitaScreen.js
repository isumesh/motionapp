...
class FormularioVisitaScreen extends Component<Props> {
    static navigationOptions = ({navigation, screenProps}) => ({
        headerTitle: `${navigation.getParam('visitaId') ? 'Edición de' : 'Nueva'} visita`,
        ...
        return (
            <ModalBox isOpen={alertModalVisible} backdropPressToClose={false} swipeToClose={false} style={styles.modal}
                ...
                <View style={styles.modalContainerButtons}>
                    ...
                    <TouchableOpacity onPress={() => this.goNuevaVisita()}
                                      style={[styles.buttonModal, styles.buttonSolid]}>
    ...
    goNuevaVisita = () => {
        const {navigation: {replace,navigate}, fromMain,tipoVisita} = this.props
    ...
    onCreateSummaryVisita = () => {
        ...
        const plataformEmpresa = plataform === undefined || plataform == "" ? null : plataform
        ...
        Object.assign(paramsForm, {jefeNTCreador: visitaId ? this.props.visita.jefeNTCreador : jefeNTCreador.usuarioNtJefe})
    ...
    renderParticipanteInput = (participante, i) => {
        ...
        return (
            <View key={i} style={inputStyle}>
                ...
                <TouchableOpacity onPress={() => visitaId ? null : this.setState({[modalName]: true})}>
                    <Text
        ...
        return (
            ...
            >
                <View style={inputStyle}>
                    ...
                    <TouchableOpacity
                        onPress={() => visitaId ? null : this.setState({grupoEconomicoModalVisible: true})}>
                        {grupoEconomico ?
        ...
        return (
            <Modal animationType={'slide'} transparent={false} visible={resumenModalVisible} onRequestClose={() => {
                ...
                <View style={{flex: 1, backgroundColor: BACKGROUND_COLOR, paddingTop: 15}}>
                    ...
                    />
                    <ScrollView>
                        <ResumenVisitaScreen title="Resumen Visita" visita={resumen}
    ...
    renderForm = () => {
        const {preguntas, respuestas, visita, currentUser, visitaId, visita: {usuarioNTCreador}, isFetchingObtenerPregunta, isValidatingApplicability, isFetchingOportunidades, isFetchingRiesgos} = this.props
            ...
            <View style={styles.container}>
                ...
                >
                    <ScrollView style={styles.formContainer}>
                        ...
                        {visitaId ? null : <TouchableOpacity onPress={() => {
                            this.agregarCliente()
                        ...
                        {!visitaId || _.size(visita.oportunidadesId) ?
                            <View style={{marginBottom: 20}}>
                                ...
                                {visitaId ? null :
                                    this.state.isHidden ? <TouchableOpacity onPress={this.goToFormularioOportunidad} style={styles.button}
                                        >
                                            <Image style={{marginRight: 10}}
                                                   source={require('./../../assets/images/icons/plus_icon.png')}/>
                ...
                <TouchableOpacity onPress={() => {
                    !isFetchingObtenerPregunta && !isValidatingApplicability && this.validationForm(true) ? this.onCreateSummaryVisita() : false
                                  ...
                                  style={!isFetchingObtenerPregunta && !isValidatingApplicability && this.validationForm() ? styles.buttonsContainer : styles.buttonsDisabledContainer}
                >
...
export default connect(mapStateToProps, mapDispatchToProps)(FormularioVisitaScreen)
