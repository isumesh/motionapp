...
class ResumenOportVisitaRealizadaScreen extends Component<Props> {
    ...
    componentDidUpdate(prevProps) {
        ...
        if (oportunidad !== prevProps.oportunidad) {
    ...
    renderSummary = (oportunidad) => {
        if (oportunidad === undefined) {
            ...
            const {resumen: {grupoEconomico, fechaCreacion}, estadoId} = oportunidad
...
export default connect(mapStateToProps, mapDispatchToProps)(ResumenOportVisitaRealizadaScreen)
